...
find_path(FLOWVRVR_BASE_INCLUDE_DIR flowvr/buffer.h
  ...
  PATHS ${CMAKE_CURRENT_SOURCE_DIR}/../../.. $ENV{FLOWVR_PREFIX} /usr/include /usr /opt )
...
foreach(FLOWVR_LIBRARY ${_FLOWVR_LIBRARIES})
   find_library(${FLOWVR_LIBRARY}_LIBRARY ${FLOWVR_LIBRARY}
      ...
      PATHS ${CMAKE_CURRENT_SOURCE_DIR}/../../.. $ENV{FLOWVR_PREFIX} /usr/local /usr /usr/local /opt /opt/local )
